...
def getdata(twp, landuse, soils, cpi, cer):
    ...
    fields = 'POLITICAL_TOWNSHIP_NAME'
...
def csvOutput(twp):
    ...
    df.to_csv(r'C:\Users\jgraves\Desktop\twpCPICER.csv', index_col=0, header=['Township', 'CER', 'CPI', "Tillable Acres"])

if __name__ == '__main__':

    arcpy.env.workspace = r'N:\landrec\Jonathan Graves\GIS\SoilsCPI.gdb'
    arcpy.env.overwriteOutput = True

    fc_twp = r'N:\landrec\Jonathan Graves\GIS\SoilsCPI.gdb\BEC_Central_SDE_PoliticalTownship'
    fc_lu = r'N:\landrec\Jonathan Graves\GIS\SoilsCPI.gdb\BEC_Central_TSSDE_landuse'
    fc_soils = r'N:\landrec\Jonathan Graves\GIS\SoilsCPI.gdb\BEC_Central_TSSDE_Soil'
    csv_cpi = r'N:\landrec\FARMS\Convert CER to CPI Project\2019CPI_ForFarms.csv'
    csv_cer = r'N:\landrec\FARMS\Convert CER to CPI Project\soilvaluetableCER.csv'
